...
- 已内置 3 套题：
  - `milu-basic`（麋鹿关系互动测评 50 题简短版）
  - `milu-pro-100`（麋鹿关系互动测评 100 题详细版）
  - `bdsm-60`（边界协同情境测评 60 题）
...
- `milu-pro-100`：
  - 题量：100
  - 定位：详细版，适合深度关系协同自评
  - 特点：强化边界协同、情境差异、复盘能力题项，题目去重

- `bdsm-60`：
  - 题量：60
  - 定位：边界协同情境版
  - 特点：覆盖约束协同、冲击反馈、角色代入、感官限制、节律控制、复盘照护、安全协议等主题，题目去重
